...
namespace App\Api\V1\Services\LogService\LogWebhook;
use App\Api\Base\LogBaseService;
use App\Mongo\LogBillLading;
use Exception;

class LogWebhookService extends LogBaseService
{
    public function __construct()
    {
        $this->servicePath = '\App\Api\V1\Services\LogService\LogWebhook';
    }
